...
import { Tooltip } from '@thumbtack/thumbprint-react';
...
export default function LangSwitch({ lang, location, truncate }) {
  ...
  return (
    <Tooltip text={formatMessage({ id: 'toggle_language' })} zIndex={2}>
      {({ ref, onMouseEnter, onClick, onFocus, onMouseLeave, onBlur, ariaLabel }) => (
        <div className="relative tp-link">
          ...
          <select
            ...
            {...{ ariaLabel, onBlur, onFocus, onMouseEnter, onMouseLeave, ref }}
            value={lang}>
